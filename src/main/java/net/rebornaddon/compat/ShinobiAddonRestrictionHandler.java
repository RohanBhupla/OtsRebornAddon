...
public class ShinobiAddonRestrictionHandler {
    ...
    private static final Set<String> ALLOWED_ITEMS = new HashSet<String>(Arrays.asList(
            ...
            "shinobiaddon:mangekyo_awakening_scroll",
            "shinobiaddon:izanagi_scroll",
            "shinobiaddon:izanami_scroll",
            "shinobiaddon:dojutsu_medical_scroll",
            "shinobiaddon:reset_path_scroll",
            "shinobiaddon:hashirama_cells",
            ...
            "shinobiaddon:tenseigan_chakra_mode_custom",
            "shinobiaddon:tenseigan_chakra_mode_custom_golden",
